export enum ROUTE_PATHS {
  ...
  MONTREAL = "/nettoyage-ventilation-montreal",
  LAVAL = "/nettoyage-ventilation-laval",
  LONGUEUIL = "/nettoyage-ventilation-longueuil",
  REPENTIGNY = "/nettoyage-ventilation-repentigny",
